...
struct ADIOI_Hints_struct {
    ...
    int *ranklist;
    int e10_cache;
    int e10_cache_flush_flag;
    int e10_cache_discard_flag;
    int e10_cache_coherent;
    int e10_cache_threads;
    char *e10_cache_path;
    int e10_collective_mode;
    union {
	    struct {
		    int listio_read;
		    int listio_write;
...
enum {
    ...
    ADIOI_HINT_PARCOLL        = 32,
    ADIOI_HINT_EXT2PH         = 64
};
...
/*
 * Available states and commands for sync thread
 */
enum {
    ADIOI_THREAD_SYNC     = 0, /* sync req */
    ADIOI_THREAD_SHUTDOWN = 1, /* shutdown req */
    ADIOI_THREAD_INITED   = 2, /* thread created */
    ADIOI_THREAD_NONE     = 3  /* thread not created */
};
...
void ADIOI_Calc_sync_groups(ADIO_File fd, ADIO_Offset *st_offsets,
...
char *ADIOI_Dirname( const char * );
char *ADIOI_Abspath( const char * );
char *ADIOI_GetCacheFilePath( const char *filename, const char *cachepath );
...
/* ROMIO profiling ... */
int  ADIOI_MPE_startup_a;
int  ADIOI_MPE_startup_b;
int  ADIOI_MPE_exchange_a;
int  ADIOI_MPE_exchange_b;
int  ADIOI_MPE_waitall_a;
int  ADIOI_MPE_waitall_b;
int  ADIOI_MPE_recv_a;
int  ADIOI_MPE_recv_b;
int  ADIOI_MPE_irecv_a;
int  ADIOI_MPE_irecv_b;
int  ADIOI_MPE_isend_a;
int  ADIOI_MPE_isend_b;
int  ADIOI_MPE_alltoall_a;
