...
static int (*_MPI_File_write_at_all) (MPI_File, MPI_Offset, const void *, int, MPI_Datatype,
                                      MPI_Status *) = NULL;
...
extern "C" {
    ...
    int __real_MPI_File_write_at_all(MPI_File, MPI_Offset, const void *, int, MPI_Datatype,
                                     MPI_Status *);
}
...
std::string key_[] = {  /* Generic hints */
    "ind_rd_buffer_size",
        ...
        "romio_cb_read",
        "romio_cb_write",
        "romio_no_indep_rw", "cb_config_list", "striping_factor", "striping_unit", "start_iodevice",
        /* Lustre hints */
        "romio_lustre_co_ratio",
        "romio_lustre_coll_threshold", "romio_lustre_cb_ds_threshould", "romio_lustre_ds_in_coll",
        /* E10 hints */
"e10_cache",
        "e10_cache_path",
        "e10_cache_flush_flag",
        "e10_cache_discard_flag", "e10_collective_mode", "e10_cache_threads"};
...
static void MPI_Wrap_init()
{
  ...
  fn_configure_api:
    ...
    _MPI_File_open =
        (int (*)(MPI_Comm, const char *, int, MPI_Info, MPI_File *)) dlsym(RTLD_NEXT,
                                                                           "MPI_File_open");
    _MPI_File_close = (int (*)(MPI_File *)) dlsym(RTLD_NEXT, "MPI_File_close");
    _MPI_File_write_all = (int (*)(MPI_File, const void *, int, MPI_Datatype, MPI_Status *)
                           dlsym(RTLD_NEXT, "MPI_File_write_all");
                           _MPI_File_write_at_all =
                           (int (*)
                            (MPI_File, MPI_Offset, const void *, int, MPI_Datatype, MPI_Status *)
...
int MPI_File_write_at_all(MPI_File fh, MPI_Offset off, const void *buf, int count,
